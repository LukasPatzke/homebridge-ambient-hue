...
export class init1618418126240 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE "point" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "x" integer NOT NULL, "y" integer NOT NULL, "first" boolean NOT NULL DEFAULT (0), "last" boolean NOT NULL DEFAULT (0), "curveId" integer)',
    );
    await queryRunner.query(
      'CREATE TABLE "curve" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "kind" varchar NOT NULL, "default" boolean NOT NULL DEFAULT (0))',
    );
    await queryRunner.query(
      'CREATE TABLE "position" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "position" integer NOT NULL DEFAULT (9999), "lightId" integer, "groupId" integer, CONSTRAINT "REL_fe3027c8acf525f8ad68d96c19" UNIQUE ("lightId"), CONSTRAINT "REL_f1610c596dc7116b51b311295f" UNIQUE ("groupId"))',
    );
    await queryRunner.query(
      'CREATE TABLE "light" ("id" integer PRIMARY KEY NOT NULL, "uniqueId" varchar NOT NULL, "name" varchar NOT NULL, "type" varchar NOT NULL DEFAULT (\'\'), "modelid" varchar NOT NULL DEFAULT (\'\'), "manufacturername" varchar NOT NULL DEFAULT (\'\'), "productname" varchar NOT NULL DEFAULT (\'\'), "on" boolean NOT NULL DEFAULT (0), "onControlled" boolean NOT NULL DEFAULT (0), "onThreshold" integer NOT NULL DEFAULT (0), "briControlled" boolean NOT NULL DEFAULT (0), "briMax" integer NOT NULL DEFAULT (254), "ctControlled" boolean NOT NULL DEFAULT (0), "smartoffOn" boolean, "smartoffBri" integer, "smartoffCt" integer, "smartoffActive" boolean NOT NULL DEFAULT (0), "published" boolean NOT NULL DEFAULT (1), "briCurveId" integer, "ctCurveId" integer)',
    );
    await queryRunner.query(
      'CREATE TABLE "group" ("id" integer PRIMARY KEY NOT NULL, "uniqueId" varchar NOT NULL, "name" varchar NOT NULL, "type" varchar NOT NULL DEFAULT (\'\'), "published" boolean NOT NULL DEFAULT (1))',
    );
    await queryRunner.query(
      'CREATE TABLE "group_lights_light" ("groupId" integer NOT NULL, "lightId" integer NOT NULL, PRIMARY KEY ("groupId", "lightId"))',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_7c21e091796fdfa486f1d51448" ON "group_lights_light" ("groupId") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_9385904050a2c6781a2358f070" ON "group_lights_light" ("lightId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "temporary_group_lights_light" RENAME TO "group_lights_light"',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_7c21e091796fdfa486f1d51448" ON "group_lights_light" ("groupId") ',
    );
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP INDEX "IDX_7c21e091796fdfa486f1d51448"');
    await queryRunner.query(
      'ALTER TABLE "group_lights_light" RENAME TO "temporary_group_lights_light"',
    );
    await queryRunner.query(
      'CREATE TABLE "group_lights_light" ("groupId" integer NOT NULL, "lightId" integer NOT NULL, PRIMARY KEY ("groupId", "lightId"))',
    );
    ...
    await queryRunner.query(
      'INSERT INTO "light"("id", "uniqueId", "name", "type", "modelid", "manufacturername", "productname", "on", "onControlled", "onThreshold", "briControlled", "briMax", "ctControlled", "smartoffOn", "smartoffBri", "smartoffCt", "smartoffActive", "published", "briCurveId", "ctCurveId") SELECT "id", "uniqueId", "name", "type", "modelid", "manufacturername", "productname", "on", "onControlled", "onThreshold", "briControlled", "briMax", "ctControlled", "smartoffOn", "smartoffBri", "smartoffCt", "smartoffActive", "published", "briCurveId", "ctCurveId" FROM "temporary_light"',
    );
    await queryRunner.query('DROP TABLE "temporary_light"');
    await queryRunner.query(
      'ALTER TABLE "position" RENAME TO "temporary_position"',
    );
    await queryRunner.query(
      'CREATE TABLE "position" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "position" integer NOT NULL DEFAULT (9999), "lightId" integer, "groupId" integer, CONSTRAINT "REL_fe3027c8acf525f8ad68d96c19" UNIQUE ("lightId"), CONSTRAINT "REL_f1610c596dc7116b51b311295f" UNIQUE ("groupId"))',
    );
    await queryRunner.query(
      'INSERT INTO "position"("id", "position", "lightId", "groupId") SELECT "id", "position", "lightId", "groupId" FROM "temporary_position"',
    );
    ...
    await queryRunner.query(
      'INSERT INTO "point"("id", "x", "y", "first", "last", "curveId") SELECT "id", "x", "y", "first", "last", "curveId" FROM "temporary_point"',
    );
