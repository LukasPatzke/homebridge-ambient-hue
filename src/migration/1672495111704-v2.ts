...
export class v21672495111704 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_light" ( "id", "legacyId", "accessoryId", "name", "archetype", "on", "onControlled", "onThreshold", "brightnessControlled", "brightnessFactor", "colorTemperatureControlled", "published", "brightnessCurveId", "colorTemperatureCurveId" ) SELECT "id", '/lights/' || "id", "uniqueId", "name", '', "on", "onControlled", "onThreshold", "briControlled", "briMax"/2.54, "ctControlled", "published", IFNULL("briCurveId", 0), IFNULL("ctCurveId", 0) FROM "light"`,
    );
